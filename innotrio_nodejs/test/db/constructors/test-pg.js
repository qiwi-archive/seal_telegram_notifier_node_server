suite('PgConstructor', function () {
    var PgConstructor = require('../../../db/classes/constructors/pg');
    suite('#insert()', function () {
        test('should construct simple insert query', function () {
            ...
            var expected = 'INSERT INTO users(id_user,user_name,user_password,user_column) VALUES(1,\'some_name\',\'1234567\',\'column\') RETURNING *;'

            var constructor = new PgConstructor(table);
        ...
        test('should construct multi insert query', function () {
            ...
            var expected = 'INSERT INTO users(id_user,user_name,user_password,user_column) VALUES(1,\'some_name\',\'1234567\',\'column\'),(2,\'some_name\',\'1234567\',\'column\') RETURNING *;'
